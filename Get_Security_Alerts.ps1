<#
.COPYRIGHT
From https://github.com/microsoftgraph/security-api-solutions/blob/master/Samples

To be used in CERT STAR Event March 10th 2020 - Milan
<#
...
(
    ...
    $clientId = "e0cfc1ea-5162-4922-a050-75a2f9ddc894"

    $redirectUri = "https://login.microsoftonline.com/common/oauth2/nativeclient"

    $resourceAppIdURI = "https://graph.microsoft.com"

    $authority = "https://login.microsoftonline.com/M365x549802.onmicrosoft.com"
